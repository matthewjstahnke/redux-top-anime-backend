...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { date: @anime.date, episodes: @anime.episodes, poster: @anime.poster, title: @anime.title } }, as: :json
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { date: @anime.date, episodes: @anime.episodes, poster: @anime.poster, title: @anime.title } }, as: :json
    assert_response 200
  end
